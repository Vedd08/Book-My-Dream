        ...
        <div className="container" ref={heroTextRef} style={{ position: 'relative', zIndex: 5, textAlign: 'center', color: '#fff', paddingTop: '6rem', paddingBottom: '9rem' }}>
          ...
          <div className="hero-quick-links hero-text-item" style={{ display: 'flex', gap: '2.5rem', justifyContent: 'center', marginTop: '2.5rem' }}>
            <Link to="/packages" className="hero-quick-link" style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.6rem', cursor: 'pointer' }}>
              <div style={{ width: 64, height: 64, borderRadius: '50%', background: 'rgba(255,255,255,0.8)', border: '2px solid rgba(255,255,255,0.6)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 25px rgba(0,0,0,0.2)', transition: 'transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1)', overflow: 'hidden' }} onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.15)'} onMouseLeave={e => e.currentTarget.style.transform = 'scale(1)'}>
                <img src="/images/holiday-packages-3d.png" alt="Holiday Packages" style={{ width: '110%', height: '110%', objectFit: 'cover' }} />
              </div>
