      ...
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', paddingBlock: '.75rem' }}>
        ...
        >
          ...
          <span style={{ display: 'flex', flexDirection: 'column', lineHeight: 1, overflow: 'hidden', minWidth: 0, width: '100%' }}>
            ...
            <span className="mobile-hidden-text" style={{ fontSize: '.65rem', fontWeight: 700, letterSpacing: '.2em', color: accentColor, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', minWidth: 0, maxWidth: '100%' }}>Ek Safar Hamare Sath</span>
          </span>
        </Link>
