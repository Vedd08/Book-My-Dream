              ...
              <form id="package-form" onSubmit={save} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  ...
                  <label style={{ gridColumn: 'span 1' }}>
                    ...
                    <input list="pkg-country-options" required value={form.country} onChange={e => update('country', e.target.value)} style={inputStyle} placeholder="Type to search or select..." />
