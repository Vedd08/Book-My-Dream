...
export default function AdminDestinations() {
  ...
  const openEdit = (dest: Destination) => {
    setForm(dest)
    setEditing(dest.slug); setShowForm(true); setMsg(''); setImageError(''); setUploadingImage(false);
  }
            ...
            <div style={{ flex: 1, overflowY: 'auto' }}>
              <form id="destination-form" onSubmit={save} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <label style={{ gridColumn: 'span 1' }}>
                  ...
                  <input list="dest-country-options" required value={form.country} onChange={e => update('country', e.target.value)} style={inputStyle} placeholder="Type to search or select..." />
